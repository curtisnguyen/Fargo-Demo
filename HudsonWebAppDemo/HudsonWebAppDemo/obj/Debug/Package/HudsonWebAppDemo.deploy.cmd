...
set _DeploySetParametersFile=%RootPath%HudsonWebAppDemo.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%HudsonWebAppDemo.zip" (
echo "%RootPath%HudsonWebAppDemo.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%HudsonWebAppDemo.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%HudsonWebAppDemo.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%HudsonWebAppDemo.deploy-readme.txt" (
...
start notepad "%RootPath%HudsonWebAppDemo.deploy-readme.txt"
)
echo =========================================================
goto :eof
